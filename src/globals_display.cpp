...
// uint8_t statt int (siehe globals_display.h) - globale Arrays sind in C++
// automatisch nullinitialisiert, daher ohne explizite {0,0,0}-Literale.
uint8_t vordergrund[MATRIX_SIZE][MATRIX_SIZE][3];

int hintergrundschema=0;
uint8_t hintergrund[MATRIX_SIZE][MATRIX_SIZE][3];

uint8_t anzeige[MATRIX_SIZE][MATRIX_SIZE][3];
uint8_t anzeigealt[MATRIX_SIZE][MATRIX_SIZE][3];
